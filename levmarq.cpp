...
*/
void solve_axb_cholesky(int n, void *t, double *x, double *b)
{
  int i,j;
  double sum;
  double (*l)[n] = static_cast<double (*)[n]>(t);
...
*/
int cholesky_decomp(int n, void *t, void *p)
{
  int i,j,k;
  double sum;

  double (*l)[n] = static_cast<double (*)[n]>(t);
  double (*a)[n] = static_cast<double (*)[n]>(p);
